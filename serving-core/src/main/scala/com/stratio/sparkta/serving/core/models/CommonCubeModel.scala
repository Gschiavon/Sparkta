...
case class CommonCubeModel(name: String,
                     checkpointConfig: CommonCheckpointModel,
                     dimensions: Seq[CommonDimensionModel],
                     operators: Seq[OperatorModel])

case class CommonDimensionModel(name: String,
                          field: String,
